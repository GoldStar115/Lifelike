...
-(id) effect10 {
    ...
    newImage = [[[self tintWithMinRGB:minrgb MaxRGB:maxrgb] contrastByFactor:0.8] brightnessByFactor:-30];
...
-(id) e1WithMinRGB:(RGBA)minRGB MaxRGB:(RGBA)maxRGB {
    ...
    maxrgb.green = 140;
    maxrgb.blue = 160;
    return [[[self tintWithMinRGB:minrgb MaxRGB:maxrgb] contrastByFactor:0.8] brightnessByFactor:10];
}
